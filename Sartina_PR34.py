...
def registration_form():
    ...
    caption = Label(text="Регистрация", font=("Bahnschrift", 14), background="#BFF4FF", foreground="#000000")
...
caption = Label(text="Вход", font=("Bahnschrift", 16), background="#BFF4FF", foreground="#000000")
...
ismarried = IntVar()
ismarried_checkbutton = Checkbutton(text="Запомнить пароль", font=("Bahnschrift", 12),  foreground="#545863", background="#BFF4FF", variable=ismarried)
ismarried_checkbutton.place(x=150, y=300, height=30, width=275, anchor="s", bordermode=OUTSIDE)

text_enter_password = Label(text="Забыли пароль?", font=("Bahnschrift", 12), background="#BFF4FF", foreground="#545863")
